...
export default function WordPanel({
  ...
  // Persistent <audio> element so it isn't garbage-collected mid-playback
  // (a detached `new Audio().play()` can be collected before sound starts).
  ...
  function playAudio(ref: string) {
    ...
    a.src = "/api/dict/audio?ref=" + encodeURIComponent(ref);
    a.play().catch(() => {
